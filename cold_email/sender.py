...
I am Neha Bharti, a B.Tech graduate (2022-2026) passionate about Artificial Intelligence and Machine Learning. I came across {company_name} and would love to explore any suitable opportunities within your organization.

During my 11-month onsite internship at Capsitech IT Services Limited, Jodhpur, I gained hands-on experience in:
...
Key Projects:
- AI Recruitment Copilot - End-to-end AI system with ATS scoring, semantic similarity, RAG pipeline, cover letter generation and automated HR outreach
- Credit Risk Intelligence Platform - ML-based credit risk assessment system
- Modular Training Pipelines - Scalable ML training infrastructure

I am actively looking for Full-Time, Internship, or Entry-Level opportunities in:
- AI / ML Engineering
- Data Science
- NLP / Generative AI
- Python Development

I have attached my resume for your kind consideration. I would be grateful for even a 10-minute conversation to discuss how I can contribute to your team.
